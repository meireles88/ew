...
-- Ideia_GrupoOrcamental [rel2]
alter table `ideia`  add column  `oid`  integer;
alter table `ideia`   add index fk_ideia_grupoorcamental (`oid`), add constraint fk_ideia_grupoorcamental foreign key (`oid`) references `grupoorcamental` (`oid`);
