...
-- Ideia_Categoria [rel2]
alter table `ideia`  add column  `categoria_oid`  integer;
alter table `ideia`   add index fk_ideia_categoria_2 (`categoria_oid`), add constraint fk_ideia_categoria_2 foreign key (`categoria_oid`) references `categoria` (`oid`);


-- Categoria_Ideia [rel3]
alter table `ideia`  add column  `categoria_oid_2`  integer;
alter table `ideia`   add index fk_ideia_categoria (`categoria_oid_2`), add constraint fk_ideia_categoria foreign key (`categoria_oid_2`) references `categoria` (`oid`);
